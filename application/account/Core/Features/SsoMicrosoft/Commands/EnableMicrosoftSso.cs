...
/// <summary>
///     Enables the Microsoft SSO configuration for the active organization.
...
public sealed record EnableMicrosoftSsoCommand : ICommand, IRequest<Result>;

public sealed class EnableMicrosoftSsoHandler(
    IOrgSsoConfigRepository ssoConfigRepository,
    IExecutionContext executionContext
) : IRequestHandler<EnableMicrosoftSsoCommand, Result>
{
    public async Task<Result> Handle(EnableMicrosoftSsoCommand command, CancellationToken cancellationToken)
    {

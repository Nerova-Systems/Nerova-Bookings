...
public sealed class AttributeConfiguration : IEntityTypeConfiguration<Attribute>
{
    public void Configure(EntityTypeBuilder<Attribute> builder)
    {
        builder.ToTable("attributes");

        builder.MapStronglyTypedUuid<Attribute, AttributeId>(a => a.Id);
        builder.MapStronglyTypedLongId<Attribute, TenantId>(a => a.TenantId);

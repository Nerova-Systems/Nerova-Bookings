...
public sealed class MockPaystackClient(IConfiguration configuration, TimeProvider timeProvider, MockPaystackState state) : IPaystackClient
{
    ...
    public Task<IReadOnlyList<PaystackBankDto>> GetBanksAsync(string country, CancellationToken cancellationToken)
    {
        ...
        [
            new("044", "Access Bank"),
            new("063", "Access Bank (Diamond)"),
            new("023", "Citibank Nigeria"),
            new("050", "EcoBank Nigeria"),
            new("011", "First Bank of Nigeria"),
            new("214", "First City Monument Bank"),
            new("070", "Fidelity Bank"),
            new("058", "Guaranty Trust Bank"),
            new("030", "Heritage Bank"),
            new("082", "Keystone Bank"),
            new("014", "MainStreet Bank"),
            new("076", "Polaris Bank"),
            new("039", "Stanbic IBTC Bank"),
            new("232", "Sterling Bank"),
            new("032", "Union Bank of Nigeria"),
            new("033", "United Bank for Africa"),
            new("215", "Unity Bank"),
            new("035", "Wema Bank"),
            new("057", "Zenith Bank")
        ];

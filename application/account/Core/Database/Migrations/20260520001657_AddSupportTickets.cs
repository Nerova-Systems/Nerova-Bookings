    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                short_display_id = table.Column<string>("text", nullable: false),
        ...
        migrationBuilder.CreateIndex("ix_support_tickets_tenant_id_short_display_id", "support_tickets", ["tenant_id", "short_display_id"], unique: true);

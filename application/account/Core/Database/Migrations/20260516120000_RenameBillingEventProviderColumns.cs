...
public sealed class RenameBillingEventProviderColumns : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.RenameIndex("ix_billing_events_stripe_event_id", "billing_events", "ix_billing_events_provider_event_id");
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.RenameIndex("ix_billing_events_provider_event_id", "billing_events", "ix_billing_events_stripe_event_id");

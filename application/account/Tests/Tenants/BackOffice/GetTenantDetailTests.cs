...
public sealed class GetTenantDetailTests : BackOfficeEndpointBaseTest
{
    ...
    public async Task GetTenantDetail_WhenSubscriptionHasRefundedTransaction_ShouldExcludeRefundFromLifetimeValue()
    {
        ...
        var transactions = ImmutableArray.Create(
            // Plain paid → counts
            new PaymentTransaction(PaymentTransactionId.NewId(), 100.00m, 80.00m, 20.00m, MockPaystackClient.MockStandardCurrency, PaymentTransactionStatus.Succeeded, DateTimeOffset.Parse("2025-01-01T00:00:00Z"), null, null, null, SubscriptionPlan.Premium, null, 100.00m),
            // Refunded status → excluded
            new PaymentTransaction(PaymentTransactionId.NewId(), 100.00m, 80.00m, 20.00m, MockPaystackClient.MockStandardCurrency, PaymentTransactionStatus.Refunded, DateTimeOffset.Parse("2025-02-01T00:00:00Z"), null, null, null, SubscriptionPlan.Premium, null, 100.00m),
            // Plain paid → counts
        ...
        Connection.Insert("subscriptions", [
                ...
                ("plan", nameof(SubscriptionPlan.Premium)),
                ("scheduled_plan", null),
                ("paystack_customer_code", "cus_test_refund"),
                ("paystack_authorization_code", "sub_test_refund"),

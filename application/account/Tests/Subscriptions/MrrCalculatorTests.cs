...
public sealed class MrrCalculatorTests
{
    ...
    public void ForwardMrr_WhenSubscriptionCancelAtPeriodEnd_ShouldReturnZero()
    {
        ...
        subscription.SetPaystackBillingState(null, SubscriptionPlan.Standard, 149m, MockPaystackClient.MockStandardCurrency, DateTimeOffset.UtcNow.AddDays(30), null);
    ...
    public void ForwardMrr_WhenScheduledDowngradeFromPremiumToStandard_ShouldReturnScheduledPrice()
    {
        // Arrange
        var subscription = Subscription.Create(TenantId.NewId());
        subscription.SetPaystackBillingState(null, SubscriptionPlan.Premium, 299m, MockPaystackClient.MockStandardCurrency, DateTimeOffset.UtcNow.AddDays(30), null);

...
// IClassFixture, the host wires its DbContext, telemetry collector, and Paystack state to a
...
public class BackOfficeWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public BackOfficeWebApplicationFactory()
    {
        ...
        Environment.SetEnvironmentVariable("Paystack__SubscriptionEnabled", "true");
        ...
        builder.ConfigureTestServices(services =>
            {
                ...
                // from the current BackOfficeTestContext. MockPaystackClient is keyed-scoped and captures
                // MockPaystackState per scope, so this delegates state mutations to the active test.

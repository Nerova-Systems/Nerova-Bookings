...
// IClassFixture, the host wires its DbContext, telemetry collector, email client, and Paystack
        ...
        builder.ConfigureTestServices(services =>
            {
                ...
                // instance from the current AccountTestContext. MockPaystackClient is keyed-scoped
                // and captures MockPaystackState per scope, so this delegates state mutations to the
                // active test.

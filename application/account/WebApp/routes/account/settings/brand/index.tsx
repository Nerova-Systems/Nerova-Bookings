...
import { DisplayNameDialog, DisplayNameStatusBadge } from "./-components/DisplayNameDialog";

export const Route = createFileRoute("/account/settings/brand/")({
  staticData: { trackingTitle: "Brand profile" },
...
function BrandProfilePage() {
   ...
   * Expected body: { businessDisplayName, brandLogoUrl?, brandAboutText?, brandDescription?,
   *   brandAddress?, brandEmail?, brandWebsites?, brandVertical }
   */
  ...
  const handleChange = () => setIsFormDirty(true);
  ...
  return (
    <>
      <AppLayout
        ...
        subtitle={t`Customise the details shown on your WhatsApp Business profile.`}
      >
        <Form onSubmit={handleSubmit} validationBehavior="aria" className="flex flex-col gap-8" onChange={handleChange}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <TextField
              ...
              onChange={(v) => {
                setFormValues((prev) => ({ ...prev, businessDisplayName: v }));
                handleChange();
              }}
              required={true}
              readOnly={readOnly}
            ...
            <TierGatedField plan={currentPlan}>
              <TextAreaField
                ...
                onChange={(v) => {
                  setFormValues((prev) => ({ ...prev, brandAboutText: v }));
                  handleChange();
                }}
            ...
            <TierGatedField plan={currentPlan}>
              <TextAreaField
                ...
                onChange={(v) => {
                  setFormValues((prev) => ({ ...prev, brandDescription: v }));
                  handleChange();
                }}
                readOnly={readOnly || !hasPaidPlan}
                disabled={!hasPaidPlan}
            ...
            <TierGatedField plan={currentPlan}>
              <TextField
                ...
                onChange={(v) => {
                  setFormValues((prev) => ({ ...prev, brandEmail: v }));
                  handleChange();
                }}
                readOnly={readOnly || !hasPaidPlan}
                disabled={!hasPaidPlan}
            ...
            <TierGatedField plan={currentPlan}>
              <TextField
                ...
                onChange={(v) => {
                  setFormValues((prev) => ({ ...prev, brandAddress: v }));
                  handleChange();
                }}
                readOnly={readOnly || !hasPaidPlan}
                disabled={!hasPaidPlan}
      ...
      <UnsavedChangesDialog
        ...
        parentTrackingTitle="Brand profile"
      />
    </>
  );
}

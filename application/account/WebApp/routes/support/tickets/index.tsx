...
function TicketCard({ ticket }: { ticket: TicketSummary }) {
  return (
    <RouterLink
      ...
      className="flex flex-col gap-2 rounded-lg border border-border bg-card px-5 py-4 text-left outline-ring transition-colors hover:bg-muted/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 active:bg-muted"
    >

...
import { Building2Icon, InboxIcon, RadioTowerIcon, UsersIcon } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <RouterLink
          className="rounded-md border border-border p-4 outline-ring transition-colors hover:bg-muted focus-visible:outline-2 focus-visible:outline-offset-2"
          to="/back-office/messaging-health"
        >
          <div className="flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-md bg-muted">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                <Trans>Check outbox, inbox, and broker subscription health.</Trans>
              </p>
            </div>
          </div>
        </RouterLink>

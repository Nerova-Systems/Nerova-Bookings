...
import { CreditCardIcon, LandmarkIcon, Loader2Icon } from "lucide-react";
...
function PayoutPanel({ subaccount, onSetup }: { subaccount?: PaystackSubaccount; onSetup: () => void }) {
...
function PaymentQueue({ payments }: { payments: PaymentIntent[] }) {
  return (
          ...
          <tbody>
            {payments.length === 0 ? (
              ...
              payments.map((payment) => (
                <tr key={payment.reference} className="border-t border-border">

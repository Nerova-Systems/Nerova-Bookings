    ...
    .AddSinglePageAppFallback(new Dictionary<string, string>
        {
            ...
            ["PUBLIC_META_APP_ID"] = builder.Configuration["WhatsApp:MetaAppId"] ?? Environment.GetEnvironmentVariable("PUBLIC_META_APP_ID") ?? string.Empty,
            ["PUBLIC_META_CONFIG_ID"] = builder.Configuration["WhatsApp:MetaConfigId"] ?? Environment.GetEnvironmentVariable("PUBLIC_META_CONFIG_ID") ?? string.Empty
        }
    );
